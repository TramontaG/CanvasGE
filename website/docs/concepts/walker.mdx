...
If you want a larger obstacle-avoidance playground with draggable blockers, see [`Enemy patrol (Walker)`](../examples/enemy-patrol).
...
For a full interactive walker demo with moving patrols, obstacle avoidance, and draggable blockers, see [`Enemy patrol (Walker)`](../examples/enemy-patrol).
